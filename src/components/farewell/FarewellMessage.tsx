    ...
    <section className="pt-8 sm:pt-10 lg:pt-16 pb-12 sm:pb-20 lg:pb-28 relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative pt-16 lg:pt-20">
          ...
          <div className="bg-foreground dark:bg-[hsl(222,47%,11%)] rounded-2xl sm:rounded-[2rem] relative overflow-hidden px-4 sm:px-6 pt-16 sm:pt-20 pb-12 sm:pb-16 lg:px-10 lg:pt-24 lg:pb-20">
            {/* Confetti pieces */}
